...
Before that, I received my M.Sc. degree from **Tianjin University** under the guidance of Prof. [Deyi Xiong](https://dyxiong.github.io/).  
...
+ Xinwei Wu, **Junzhuo Li**, Minghui Xu, Weilong Dong, Shuangzhi Wu, Chao Bian, and Deyi Xiong.  
  ...
  *EMNLP 2023 (Long Papers)*, Singapore.  

+ Shaoyang Xu, **Junzhuo Li**, and Deyi Xiong.  
  [Language Representation Projection: Can We Transfer Factual Knowledge across Languages in Multilingual Language Models?](https://arxiv.org/abs/2311.03788)  
  *EMNLP 2023 (Short Papers)*, Singapore.  

+ Chuang Liu, **Junzhuo Li**, and Deyi Xiong.  
  [Tab-CQA: A Tabular Conversational Question Answering Dataset on Financial Reports](https://aclanthology.org/2023.acl-industry.20.pdf)  
  *ACL 2023 (Industry Track)*, Toronto, Canada.  

+ **Junzhuo Li** and Deyi Xiong.  
  [KaFSP: Knowledge-Aware Fuzzy Semantic Parsing for Conversational Question Answering over a Large-Scale Knowledge Base](https://aclanthology.org/2022.acl-long.35.pdf)  
